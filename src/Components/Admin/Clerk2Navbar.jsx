...
const Clerk2Navbar = ({ activeTab, setActiveTab }) => {
  return (
    <nav className="w-full h-[64px] bg-gradient-to-r rounded-2xl from-[#1D134A] to-[#410F14] shadow px-4 sm:px-8 lg:px-20 flex items-center justify-between">
