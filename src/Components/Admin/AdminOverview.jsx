...
const AdminOverview = () => {
    return (
        <div className={`bg-gray-50 min-h-screen ${poppins.className}`}>
            ...
            {/* HEADER */}
            <div className="max-w-[1440px] mx-auto h-auto sm:h-[80px] px-4 sm:px-8 md:px-[100px] py-4 sm:py-0 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-8 md:px-[100px] py-6 sm:py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                    ...
                    <div key={i} className="w-full h-[136px] bg-white border border-[#E5E7EB] rounded-[12px] p-4 flex flex-col justify-between shadow-sm">
            ...
            <div className="max-w-[1440px] mt-[30px] mx-auto px-4 sm:px-8 md:px-[100px]">
                <div className="flex flex-col md:flex-row gap-6 w-full justify-center md:justify-start items-start md:items-stretch">
                    ...
                    <div className="bg-white shadow-md rounded-[12px] border border-gray-200 px-6 pt-6 pb-12 flex flex-col gap-6 w-full md:w-[440px]">
                        <h3 className="flex items-center text-[24px] text-[#0F1729] font-bold gap-2">
