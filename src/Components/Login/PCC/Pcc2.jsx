...
const Pcc2 = () => {
    ...
    const handleNext = (e) => {
        e.preventDefault();
        if (validate()) {
            window.location.href = "/Tenant/review2"; // ✅ move to next step
        }
    };
            ...
            <div className="w-full max-w-5xl flex flex-col gap-6">
                ...
                <div className="w-full bg-white border border-gray-300 rounded-2xl p-4 sm:p-6 flex flex-col gap-6">
                    <div className="flex flex-col items-center w-full">
                        <h3 className="text-gray-800 font-semibold text-lg mb-4">Tenant Police Verification details</h3>
