            ...
            <div className="w-full max-w-5xl flex flex-col gap-6">
                ...
                <div className="w-full bg-white border border-gray-300 rounded-2xl p-4 sm:p-6 flex flex-col gap-6">
                    <div className="flex flex-col items-center w-full">
                        <h3 className={`text-[#0A0A0A] ${poppins.className} font-normal text-lg mb-4`}>Landlord Bank Details</h3>
                    ...
                    <form className="w-full flex flex-col gap-4">
                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row gap-4 w-full">
                                <div className="flex-1 flex flex-col">
                                    <label htmlFor="ifscCode" className={`text-gray-900 text-sm mb-1 ${poppins.className}`}>Enter IFSC Code</label>
                                    <input
                                        id="ifscCode"
                                        type="text"
                        ...
                        <div className="flex flex-col sm:flex-row justify-between gap-4 mt-4 w-full">
                            <Link href="/Landlord/propertyownership"
