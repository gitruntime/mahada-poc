  ...
  return (
    <div className="mt-[60px]">
      ...
      <div className="max-w-[1380px] mx-auto px-[40px] flex items-center justify-between mb-6">
        ...
        <a href="/Tenant/allpropertyTenant" className={`text-gray-900 ${poppins.className} flex items-center gap-1`}>
...
export default ProperPageTenant;
