...
const PropertyRightDisableRent = () => {
  return (
    <div className="w-[full] bg-white rounded-[12px] border border-[#E5E7EB] p-6 shadow-sm">
      ...
      <div className="flex gap-3 mb-4">
        {/* Rent Property */}
        <button className="flex-1 flex items-center cursor-pointer justify-center gap-2 bg-[#F97415] text-white py-2 rounded-xl font-medium text-[16px] 
...
export default PropertyRightDisableRent;
