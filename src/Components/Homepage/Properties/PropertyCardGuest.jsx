...
const PropertyCardGuest = ({ property }) => {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-col justify-between flex-1 p-5">
        ...
        <div className="pt-4 border-t border-[#E5E7EB] flex items-center justify-between mt-3">
          ...
          <Link href="/propertydetailsguest" className="bg-orange-500 hover:bg-orange-600 transition text-white text-[14px] font-medium px-5 py-3 rounded-[12px] shadow-lg">
            View Details
          </Link>
        </div>
      </div>
...
export default PropertyCardGuest;
