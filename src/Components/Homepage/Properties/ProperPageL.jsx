...
import PropertyCardL from "./PropertyCardL";
  ...
  return (
    <div className="mt-[60px]">
      ...
      <div className="max-w-[1380px] mx-auto px-[40px] flex items-center justify-between mb-6">
        ...
        <a href="#" className={`text-gray-900 ${poppins.className} flex items-center gap-1`}>
        ...
        >
          {properties.map((property) => (
            <SwiperSlide key={property.id}>
              <PropertyCardL property={property} className="hover:scale-105 transition-transform duration-300" />
            </SwiperSlide>
          ))}
