                            ...
                            <div className={`bg-[#FCF0E4] rounded-xl ${poppins.className} p-5`}>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex justify-between items-center bg-[#FFF7EF] px-3 py-2 rounded-md">
                                            <span className="text-[#525252] text-[14px]">Receipt ID</span>
                                            <span className="text-[#171717] font-medium text-[14px]">MHADA-TNT-REG-002381</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
