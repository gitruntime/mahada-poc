...
const Done = () => {
    ...
    return (
        <div className={poppins.className}>
            ...
            {/* MAIN CARD WRAPPER */}
            <div className="flex flex-col md:flex-row justify-center mt-10 px-4 sm:px-6 lg:px-20 gap-6">
                {/* LEFT CARD */}
                <div
                    className="
              w-full md:w-[440px] h-auto md:h-[440px]
              rounded-[12px]
            ...
            "
                >
                    ...
                    <div className="flex flex-col justify-between flex-1 p-5">
                        <div>
                            ...
                            {/* Info */}
                            <div className="flex flex-wrap md:flex-nowrap items-start md:items-center gap-3 md:gap-6 text-[#6B7280] text-[14px] mt-3">
                        ...
                        {/* Footer */}
                        <div className="pt-4 border-t border-[#E5E7EB] flex flex-col md:flex-row items-start md:items-center justify-between mt-3 gap-2 md:gap-0">
                            <div>
                ...
                <div
                    className="
              shadow-[0px_4px_20px_-2px_rgba(229,231,235,0.8)]
              w-full md:w-[326px] h-auto md:h-[440px]
              rounded-[12px]
              border border-[#0000001A]
              bg-white
            ...
            "
                >
                    <div className="flex items-center justify-center">
                        <Image src="/check_icon.png" width={64} height={64} alt="check icon" />
                    </div>
